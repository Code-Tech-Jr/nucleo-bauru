      ...
      <Content className="flex-col items-stretch gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Text variant={'dark'} className="text-justify">
            ...
            Juntas, construímos um movimento mais forte, mostrando que, quando caminhamos
            em rede, o desenvolvimento de uma Empresa Júnior impulsiona o sucesso de
            todas.
          </Text>
        </div>
        ...
        <div className="grid w-full grid-cols-1 gap-6 min-[1300px]:grid-cols-[55fr_45fr] min-[1300px]:items-start min-[1300px]:[grid-template-areas:'busca_mapa''cards_mapa']">
